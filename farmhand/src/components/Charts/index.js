...
export default class Charts extends Component {
  ...
  getChartsData = async () => {
    ...
    try {
      const response = await axios.get('http://kaioru.ngrok.io/decks/' + id + '/indicators/week', {
        headers: {
        ...
        <div>
          <section className="react-rainbow-admin-charts_section rainbow-p-top_large">
            ...
            >
              <Dataset
                title="Plant 1"
                values={[11.45, 14.64, 13.32, 12.56, 14.79, 13.29, 12.06, 14.04, 13.12, 12.65]}
                borderColor="#fe4849"
                backgroundColor="#fe4849"
              />
              <Dataset
                title="Plant 2"
                values={[10.23, 14.35, 12.8, 11.35, 14.06, 12.59, 11.02, 14.9, 13.24, 11.53]}
                borderColor="#01b6f5"
            ...
            <section className="react-rainbow-admin-charts_section rainbow-p-top_large">
              ...
              >
                <Dataset
                  title="Temperature"
                  values={[32, 30, 31, 33, 32.5, 32.23, 30.65, 29.5, 28.9, 28.2]}
                  borderColor="#01b6f5"
                  backgroundColor="#01b6f5"
                />
              </ChartCard>
